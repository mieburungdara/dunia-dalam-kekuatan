...
Data profesi Knight sekarang dikelola dalam format JSON untuk kemudahan akses dan konsistensi.

Untuk melihat detail lengkap profesi Knight, silakan merujuk ke file:
*   `_role/KNIGHT.json`

## Struktur Data Profesi Knight (JSON)

Objek profesi Knight dalam `_role/KNIGHT.json` mengikuti struktur berikut:
